package com.example.chexiangjia_mac.myapplication;
...
import com.example.chexiangjia_mac.myapplication.fragment.BaseFragment;
import com.example.chexiangjia_mac.myapplication.fragment.FragmentFactory;


public class MainActivity extends FragmentActivity implements DrawerLayout.DrawerListener, DrawerFragment.OnDrawerItemSelectedListener, View.OnClickListener {
    ...
    private DrawerFragment mfgConversation = new DrawerFragment();
    private android.support.v4.app.FragmentManager mfgManager = getSupportFragmentManager();
...
//        super.onResume();
//        FragmentTransaction fgTransaction = mfgManager.beginTransaction();
//        fgTransaction.add(R.id.rl_co,mfgConversation);
...
//        super.onPause();
//        FragmentTransaction fgTransaction = mfgManager.beginTransaction();
//        fgTransaction.remove(mfgConversation);
//        fgTransaction.commit();
//    }
    private void initDrawer() {
        ...
        tv_caidan=(TextView)findViewById(R.id.tv_caidan);
        tv_caidan.setOnClickListener(this);
    }
